...
public class ViewParametresPuzzleController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		formatPuzzle.getItems().addAll("1x4", "1x5", "1x6");
		...
		if (score_init.getText().isEmpty() || decr_points.getText().isEmpty() || decr_sec.getText().isEmpty()
			...
			if (!ViewAddOrModifyInstructionController.tryParseDouble(score_init.getText())
				...
				case "1x4":
					...
					if (frag1_4_1.getText().isEmpty() || frag1_4_2.getText().isEmpty() || frag1_4_3.getText().isEmpty()
							|| frag1_4_4.getText().isEmpty()) {
				...
				case "1x5":
					...
					if (frag1_5_1.getText().isEmpty() || frag1_5_2.getText().isEmpty() || frag1_5_3.getText().isEmpty()
							|| frag1_5_4.getText().isEmpty() || frag1_5_5.getText().isEmpty()) {
						errorFragment.setVisible(true);
					} else {
						if (nbIndices.getValue().equals(1) && !indice1.getText().isEmpty()
								|| nbIndices.getValue().equals(2) && !indice1.getText().isEmpty()
				...
				case "1x6":
					...
					if (frag1_6_1.getText().isEmpty() || frag1_6_2.getText().isEmpty() || frag1_6_3.getText().isEmpty()
							|| frag1_6_4.getText().isEmpty() || frag1_6_5.getText().isEmpty()
							|| frag1_6_6.getText().isEmpty()) {
						errorFragment.setVisible(true);
					} else {
						if (nbIndices.getValue().equals(1) && !indice1.getText().isEmpty()
								|| nbIndices.getValue().equals(2) && !indice1.getText().isEmpty()
	...
	private void creerXML() {
		...
		Puzzle p = new Puzzle("Nom", Double.parseDouble(score_init.getText().toString()),
				Double.parseDouble(decr_points.getText().toString()), Double.parseDouble(decr_sec.getText().toString()),
				Double.parseDouble(score_min.getText().toString()), description.getText().toString(), fragmentType,
				listeIndices, listeFragments);
