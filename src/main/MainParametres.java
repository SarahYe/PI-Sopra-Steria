...
public class MainParametres extends Application {
	...
	private final ObservableList<Question> data = FXCollections.observableArrayList(
			// new Question ("Quel est l'intru parmis ces r�ponses ?",ListeReponses),
	...
	public void start(Stage primaryStage) {
		primaryStage.setTitle("Page principale de param�trage");
		Group root = new Group();
		Scene scene = new Scene(root, 500, 500, Color.WHITE);

		/*
		 * ArrayList<Reponse> ListeReponses1 = new ArrayList<Reponse>();
		 * ListeReponses1.add(new Reponse("pomme de terre", true,
		 * "il s'agit en effet de la bonne r�ponse !")); ListeReponses1.add(new
		 * Reponse("patate", false, "bien s�r que non, c'�tait la pomme de terre !"));
		 * data.set(0, new Question
		 * ("Quel est l'intru parmis ces r�ponses ?",ListeReponses1));
		 * 
		 * ArrayList<Reponse> ListeReponses2 = new ArrayList<Reponse>();
		 * ListeReponses2.add(new Reponse("42", true,
		 * "Vous n'avez pas compris la question, mais bonne r�ponse !"));
		...
		TableColumn<Question, String> titreCol = new TableColumn<Question, String>("Intitul� des questions");
		titreCol.setMinWidth(450);
		titreCol.setCellValueFactory(new PropertyValueFactory<Question, String>("intituleQuestion"));
		...
		boutonModifier.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				Label labelR1 = new Label("Intitul� de la r�ponse 1 :");
				TextField textFieldR1 = new TextField(
						table.getSelectionModel().getSelectedItem().getListeReponses().get(0).getIntitule());
				HBox hbR1 = new HBox();
				hbR1.getChildren().addAll(labelR1, textFieldR1);
				hbR1.setSpacing(10);
				CheckBox cbR1 = new CheckBox("R�ponse correcte");
				...
				TextArea textFieldR1J = new TextArea(
						table.getSelectionModel().getSelectedItem().getListeReponses().get(0).getJustification());
				textFieldR1J.setMaxSize(400, 60);
				VBox vbR1 = new VBox();
				vbR1.getChildren().addAll(hbR1, cbR1, textFieldR1J);
				...
				Label labelR2 = new Label("Intitul� de la r�ponse 2 :");
				TextField textFieldR2 = new TextField(
						table.getSelectionModel().getSelectedItem().getListeReponses().get(1).getIntitule());
				HBox hbR2 = new HBox();
				hbR2.getChildren().addAll(labelR2, textFieldR2);
				hbR2.setSpacing(10);
				CheckBox cbR2 = new CheckBox("R�ponse correcte");
				...
				TextArea textFieldR2J = new TextArea(
						table.getSelectionModel().getSelectedItem().getListeReponses().get(1).getJustification());
				textFieldR2J.setMaxSize(400, 60);
				VBox vbR2 = new VBox();
				vbR2.getChildren().addAll(hbR2, cbR2, textFieldR2J);
